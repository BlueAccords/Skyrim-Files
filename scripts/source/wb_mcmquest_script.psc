...
String Property WB_Alteration_Collapse_Setting_XP Auto
String Property WB_Alteration_Grindstone_Setting_Mult Auto
String Property WB_Alteration_Grindstone_Setting_XP Auto
String Property WB_Alteration_ShalidorsMirror_Setting_XP Auto
...
String Property WB_Illusion_Reave_Setting_Percentage Auto
...
String Property WB_Illusion_Reave_Setting_XP Auto
...
GlobalVariable Property WB_Alteration_Grindstone_Global_Mult Auto
GlobalVariable Property WB_Alteration_Grindstone_Global_XP Auto
...
GlobalVariable Property WB_Illusion_Reave_Global_XP Auto
...
String Property WB_Alteration_Collapse_Highlight_XP Auto
String Property WB_Alteration_Grindstone_Highlight_Mult Auto
String Property WB_Alteration_Grindstone_Highlight_XP Auto
String Property WB_Alteration_ShalidorsMirror_Highlight_XP Auto
...
String Property WB_Illusion_Reave_Highlight_Percentage Auto
...
String Property WB_Illusion_Reave_Highlight_XP Auto
...
String Property WB_Alteration_Grindstone_Format_Mult Auto
...
String Property WB_Illusion_Reave_Format_Percentage Auto
...
Int IDACollapseXP
Int IDAGrindstoneMult
Int IDAGrindstoneXP
Int IDAShalidorsMirrorXP
...
Event OnPageReset(string page)
		...
		IDAGrindstoneMult = AddSliderOption(WB_Alteration_Grindstone_Setting_Mult, WB_Alteration_Grindstone_Global_Mult.GetValueInt(), WB_Alteration_Grindstone_Format_Mult)
		...
		IDIReavePercentage = AddSliderOption(WB_Illusion_Reave_Setting_Percentage, WB_Illusion_Reave_Global_Percentage.GetValueInt(), WB_Illusion_Reave_Format_Percentage)
		...
		IDACollapseXP = AddSliderOption(WB_Alteration_Collapse_Setting_XP, WB_Alteration_Collapse_Global_XP.GetValue(), WB_General_Format_XP)
		...
		IDAGrindstoneXP = AddSliderOption(WB_Alteration_Grindstone_Setting_XP, WB_Alteration_Grindstone_Global_XP.GetValue(), WB_General_Format_XP)
		...
		IDIReaveXP = AddSliderOption(WB_Illusion_Reave_Setting_XP, WB_Illusion_Reave_Global_XP.GetValue(), WB_General_Format_XP)
		...
		IDAShalidorsMirrorXP = AddSliderOption(WB_Alteration_ShalidorsMirror_Setting_XP, WB_Alteration_ShalidorsMirror_Global_XP.GetValue(), WB_General_Format_XP)
...
Event OnOptionHighlight(int OP)
	...
	ElseIf OP == IDACollapseXP
		SetInfoText(WB_Alteration_Collapse_Highlight_XP)
	ElseIf OP == IDAGrindstoneMult
		SetInfoText(WB_Alteration_Grindstone_Highlight_Mult)
	ElseIf OP == IDAGrindstoneXP
		SetInfoText(WB_Alteration_Grindstone_Highlight_XP)
	ElseIf OP == IDAShalidorsMirrorXP
		SetInfoText(WB_Alteration_ShalidorsMirror_Highlight_XP)
	...
	ElseIf OP == IDIReavePercentage
		SetInfoText(WB_Illusion_Reave_Highlight_Percentage)
	...
	ElseIf OP == IDIReaveXP
		SetInfoText(WB_Illusion_Reave_Highlight_XP)
...
Event OnOptionSliderOpen(int OP)
	...
	If OP == IDXP
		...
		e = 5.0
	ElseIf OP == IDACollapseXP
		a = WB_Alteration_Collapse_Global_XP.GetValue()
		b = 0.5
		c = 0.1
		d = 0.1
		e = 1.5
	ElseIf OP == IDAGrindstoneMult
		a = WB_Alteration_Grindstone_Global_Mult.GetValueInt()
		b = 50
		c = 10
		d = 10
		e = 250
	ElseIf OP == IDAGrindstoneXP
		a = WB_Alteration_Grindstone_Global_XP.GetValue()
		b = 0.5
		c = 0.1
		d = 0.1
		e = 1.5
	ElseIf OP == IDAShalidorsMirrorXP
		a = WB_Alteration_ShalidorsMirror_Global_XP.GetValue()
		b = 0.1
		c = 0.1
		d = 0.1
		e = 0.5
	...
	ElseIf OP == IDIPaleMoonDrain
		...
		e = 250
	ElseIf OP == IDIReavePercentage
		a = WB_Illusion_Reave_Global_Percentage.GetValueInt()
		b = 20
		c = 5
		d = 5
		e = 30
	...
	ElseIf OP == IDIEmpathicAgonyXP
		...
		e = 1.5
	ElseIf OP == IDIReaveXP
		a = WB_Illusion_Reave_Global_XP.GetValue()
		b = 0.5
		c = 0.1
		d = 0.1
		e = 1.5
...
Event OnOptionSliderAccept(int OP, float afValue)
	...
	ElseIf OP == IDACollapseXP
		WB_Alteration_Collapse_Global_XP.SetValue(afValue)
		SetSliderOptionValue(IDACollapseXP, afValue, WB_General_Format_XP)
	ElseIf OP == IDAGrindstoneMult
		WB_Alteration_Grindstone_Global_Mult.SetValueInt(afValue as Int)
		SetSliderOptionValue(IDAGrindstoneMult, afValue, WB_Alteration_Grindstone_Format_Mult)
	ElseIf OP == IDAGrindstoneXP
		WB_Alteration_Grindstone_Global_XP.SetValue(afValue)
		SetSliderOptionValue(IDAGrindstoneXP, afValue, WB_General_Format_XP)
	ElseIf OP == IDAShalidorsMirrorXP
		WB_Alteration_ShalidorsMirror_Global_XP.SetValue(afValue)
		SetSliderOptionValue(IDAShalidorsMirrorXP, afValue, WB_General_Format_XP)
	ElseIf OP == IDAUndermineMult
	...
	ElseIf OP == IDIReavePercentage
		WB_Illusion_Reave_Global_Percentage.SetValueInt(afValue as Int)
		SetSliderOptionValue(IDIReavePercentage, afValue, WB_Illusion_Reave_Format_Percentage)
	ElseIf OP == IDILobotomizeMult
	...
	ElseIf OP == IDIReaveXP
		WB_Illusion_Reave_Global_XP.SetValue(afValue)
		SetSliderOptionValue(IDIReaveXP, afValue, WB_General_Format_XP)
	ElseIf OP == IDIScreamOfPainXP
